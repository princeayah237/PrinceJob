...
const [range, setRange] = useState<[number, number]>([fromFiled.value || minSalary, toField.value || maxSalary / 2,
...
function handleChange(value: number []) {
   ...
   return (
     <div className="w-full space-y-4">
        <Slider onValueChange={handleChange} min={minSalary} max={maxSalary} step={step} value={range} />
