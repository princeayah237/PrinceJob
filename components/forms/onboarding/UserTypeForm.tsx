    ...
    return (
        <div className="space-y-8">
            <div className="text-center space-y-2">
               ...
               <p className="text-muted-foreground">Choose how you would like to use platform!</p>
            </div>

          <div className="grid gap-4">
            <Button 
            onClick={() => onSelect("company")}
            variant="outline" className="w-full h-auto p-6
             items-center gap-4 border-2 transition-all duration-200
              hover:border-primary hover:bg-primary/5">
<div className="size-12 rounded-full bg-primary/10 flex items-center
 justify-center">
